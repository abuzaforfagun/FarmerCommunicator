namespace FarmmerCommunicatorFinal.Migrations
{
    ...
    public partial class AddBuyerInDeal : DbMigration
    {
        public override void Up()
        {
            ...
            AddColumn("dbo.Deals", "Buyer_Id", c => c.String(maxLength: 128));
            ...
            CreateIndex("dbo.Deals", "Buyer_Id");
            ...
            AddForeignKey("dbo.Deals", "Buyer_Id", "dbo.IdentityUsers", "Id");
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Deals", "Buyer_Id", "dbo.IdentityUsers");
            DropIndex("dbo.AspNetUsers", new[] { "Id" });
            DropIndex("dbo.AspNetUserRoles", new[] { "IdentityUser_Id" });
            DropIndex("dbo.AspNetUserLogins", new[] { "IdentityUser_Id" });
            DropIndex("dbo.AspNetUserClaims", new[] { "IdentityUser_Id" });
            DropIndex("dbo.IdentityUsers", "UserNameIndex");
            DropIndex("dbo.Deals", new[] { "Buyer_Id" });
