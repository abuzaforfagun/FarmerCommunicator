namespace FarmmerCommunicatorFinal.Migrations
{
    ...
    public partial class AddFarmerInProduct : DbMigration
    {
        public override void Up()
        {
            ...
            AddColumn("dbo.Products", "FarmerId", c => c.Int(nullable: false));
            AddColumn("dbo.Products", "Farmer_Id", c => c.String(maxLength: 128));
            ...
            AddForeignKey("dbo.Products", "Farmer_Id", "dbo.IdentityUsers", "Id");
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Products", "Farmer_Id", "dbo.IdentityUsers");
